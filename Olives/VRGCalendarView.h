...
//#define kVRGCalendarViewWidth 20
//
//#define kVRGCalendarViewDayWidth 47
//#define kVRGCalendarViewDayHeight 47
...
// default size for each device screen size
@property (nonatomic,assign) NSInteger kVRGCalendarViewTopBarHeight;
@property (nonatomic,assign) NSInteger kVRGCalendarViewWidth;
@property (nonatomic,assign) NSInteger kVRGCalendarViewDayWidth;
@property (nonatomic,assign) NSInteger kVRGCalendarViewDayHeight;
